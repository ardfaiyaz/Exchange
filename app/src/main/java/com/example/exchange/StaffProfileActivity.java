...
public class StaffProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.staffreserveationbtn).setOnClickListener(view -> {
            Intent intent = new Intent(StaffProfileActivity.this, StaffReservationActivity.class);
            startActivity(intent);
        });
        ...
        findViewById(R.id.staffhomebtn).setOnClickListener(view -> {
            Intent intent = new Intent(StaffProfileActivity.this, UserHomePageActivity.class);
            startActivity(intent);
        });
    }
